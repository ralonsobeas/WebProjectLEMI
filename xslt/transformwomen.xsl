	...
	<xsl:template match="/">
				...
				<ul id="myMenu" class="menu">
					...
					<li> 
						...
						<ul class="submenuproducts" style="left:132vh;width:12vh;">
							...
							<li> <a href="javascript:void(0);" style="color:skyblue" >Women</a> </li>
						</ul>
					</li>
					<li> 
		...
		<section >
			<div style="text-align:center">
				...
				<p><xsl:value-of select="count($cataloguexml//catalogue/stock/product[gender='female'])"/> Products</p>
			</div>
			<p>
				Ordered by year
				...
				<table>
					...
					<xsl:for-each select="$cataloguexml/catalogue/stock/product[gender='female']">
						...
						<xsl:choose>
							...
							<xsl:when test="position() mod 2 = 1">
									...
									<!--Column 2  -->
									<xsl:for-each select="//catalogue/stock/product[gender='female']" >
										<!--Select next product -->
										<xsl:sort select="year" order="descending"/>
