	...
	<xsl:template match="/">
		...
		<nav id="navpages" class="navpages" >
				...
				<ul id="myMenu" class="menu">
					...
					<li> 
						<a href="javascript:void(0);" style="color:skyblue">Catalogue</a>
						<ul class="submenuproducts" style="left:132vh;width:12vh;">
							<li> <a href="javascript:void(0);" style="color:skyblue" >Full</a> </li>
		...
		<section >
			<div style="text-align:center">
				<h1> CATALOGUE</h1>
				<p><xsl:value-of select="count($cataloguexml//catalogue/stock/product)"/> Products</p>
			</div>
			<p>
				Ordered by year
				...
				<table >
					...
					<xsl:for-each select="$cataloguexml/catalogue/stock/product">
						...
						<xsl:choose>
							...
							<xsl:when test="position() mod 2 = 1">
								<!--Column 1  -->
									...
									<!--Column 2  -->
									<xsl:for-each select="//catalogue/stock/product" >
										<!--Select next product -->
