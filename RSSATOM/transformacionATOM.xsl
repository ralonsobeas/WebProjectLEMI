	...
	<xsl:template match="/">
				...
				<ul id="myMenu" class="menu">
					...
					<li> 
						...
						<ul class="submenuproducts" style="left:168vh;width:12vh;">
							...
							<li> <a href="javascript:void(0);" style="color:skyblue">ATOM</a> </li>
						</ul>
					</li>
			</ul>
		</nav>
		...
		<section >
			<div style="text-align:center">
				<h1>ATOM NEWS</h1>
				<p><xsl:value-of select="count(atom:feed/atom:entry)"/> NEWS BY <xsl:value-of select="atom:feed/atom:author"/></p>
			</div>
					...
					<xsl:for-each select="atom:feed/atom:entry">
						<tr>
							<td style="border: solid;border-radius:5%;">
								...
								<p><xsl:value-of select="atom:category/@term" /> / <xsl:value-of select="atom:updated" /></p>
								<h3><xsl:value-of select="atom:summary" /></h3>
							</td>	
						</tr>
					</xsl:for-each>
				</table>
